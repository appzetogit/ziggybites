...
1. Open [Firebase Console](https://console.firebase.google.com) → your project (e.g. **ziggybites**).
...
- `FIREBASE_DATABASE_URL=https://ziggybites-default-rtdb.asia-southeast1.firebasedatabase.app`
