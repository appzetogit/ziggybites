      ...
      {isInView && (
        <picture className="absolute inset-0 w-full h-full">
          ...
          <motion.img
            ...
            alt={alt}
            className={`w-full h-full ${objectFit === 'cover' ? 'object-cover object-center' : objectFit === 'contain' ? 'object-contain object-center' : objectFit === 'fill' ? 'object-fill' : objectFit === 'none' ? 'object-none' : 'object-cover object-center'} ${priority || isLoaded ? 'opacity-100' : 'opacity-0'} ${!priority && 'transition-opacity duration-300'}`}
