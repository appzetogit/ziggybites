...
import { ArrowLeft, Star, Clock, MapPin, ShoppingBag, Plus, Minus, Calendar, ThumbsUp, MessageCircle, Send, Repeat, ChefHat } from "lucide-react"
...
export default function ProductDetail() {
  ...
  // ZigZagLite: subscription plan and special cooking instructions for vendor
  ...
  const getSpecialCookingInstructions = () => {
    const parts = []
  ...
  const handleAddToCart = () => {
    if (product) {
      const instructions = getSpecialCookingInstructions()
      const itemToAdd = { ...product, specialCookingInstructions: instructions }
    ...
    <AnimatedPage className="min-h-screen bg-gradient-to-b from-yellow-50/30 via-white to-orange-50/20 dark:from-[#0a0a0a] dark:via-[#0a0a0a] dark:to-[#0a0a0a]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12">
        ...
        <div className="px-4 sm:px-6 md:px-8 lg:px-10 py-6 sm:py-8 md:py-10 lg:py-12 space-y-6 md:space-y-8 lg:space-y-10">
          ...
          {/* ZigZagLite: Subscription plan & special cooking instructions */}
          <ScrollReveal delay={0.2}>
            <div className="space-y-4 pb-4 border-b">
              <h2 className="text-lg font-bold flex items-center gap-2">
                <Repeat className="h-5 w-5 text-[#DC2626]" />
                Subscription plan
              </h2>
              <p className="text-sm text-muted-foreground">Optional – choose a plan or order once</p>
            ...
            <div className="space-y-3 pt-4 pb-4 border-b">
              ...
              <p className="text-sm text-muted-foreground">Vendor will see these</p>
              ...
              <Textarea
                placeholder="Other (e.g. no onion, less oil)"
