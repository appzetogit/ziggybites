  ...
  return (
    <AnimatedPage className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-[#0a0a0a] dark:to-[#1a1a1a]">
      <div className="max-w-4xl mx-auto px-4 md:px-6 lg:px-8 py-6 md:py-8">
        ...
        >
          {/* ZigZagLite: No Refund Policy notice */}
          <div className="mb-6 p-4 rounded-lg border-2 border-[#DC2626]/30 bg-[#DC2626]/5 dark:bg-[#DC2626]/10">
            <p className="font-semibold text-[#DC2626] dark:text-red-400">ZigZagLite – No Refund Policy</p>
            <p className="text-gray-700 dark:text-gray-300 mt-1 text-sm">
              Once a subscription is purchased, no refunds are provided. You may only cancel future deliveries; already paid periods are non-refundable.
            </p>
          </div>

          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
            <Receipt className="h-6 w-6 md:h-7 md:w-7 text-[#DC2626] dark:text-red-400" />
            {refundData.title}
          </h2>
          <div
