          ...
          >
            {categories.map((cat) => {
              ...
              return (
                ...
                >
                  {cat.image ? (
                    <div className={`w-16 h-16 rounded-2xl overflow-hidden border-2 transition-all ${isSelected ? 'border-green-600 dark:border-green-500 shadow-lg' : 'border-transparent'
                      }`}>
                      <img
                        src={cat.image}
                        alt={cat.name}
