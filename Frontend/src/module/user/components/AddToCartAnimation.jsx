      ...
      {itemCount > 0 && !shouldHidePill && typeof document !== 'undefined' && createPortal(
          ...
          >
            ...
            <button
              ...
              className={`bg-[#2A9C64] text-white rounded-full shadow-xl shadow-[#1b5f3e]/40 px-3 py-2 flex items-center gap-2 hover:bg-[#238654] transition-all duration-300 pointer-events-auto border border-[#1b5f3e]/40 backdrop-blur-sm cursor-pointer ${pillClassName}`}
            >
