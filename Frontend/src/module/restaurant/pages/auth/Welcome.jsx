      ...
      >
        ...
        <div className="text-center mt-2">
          <p className="text-white/70 text-xs md:text-sm">
            ...
            <Link to="/restaurant/terms" className="text-white/90 underline hover:text-white">Terms of Service</Link>
            {" | "}
            <Link to="/restaurant/privacy" className="text-white/90 underline hover:text-white">Privacy Policy</Link>
          </p>
        </div>
      </div>
    </div>
